...
def parse_args():
    ...
    parser.add_argument('--sac_real_replay_buffer_capacity', default=1000000, type=int)
    parser.add_argument('--sac_sim_replay_buffer_capacity', default=4000000, type=int)
    ...
    parser.add_argument('--imagination_horizon', default=10, type=int)
    parser.add_argument('--horizon_increase', default=0.0, type=float)
    parser.add_argument('--max_imagination_horizon', default=30, type=int)
    parser.add_argument('--use_real_data', default=False, action='store_true')
