...
class FetchReachEnv(fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', randomize_light=False, randomize_camera=False,
                 randomize_target_color=False, randomize_table_color=False, randomize_floor_color=False,
                 randomize_background_color=False, randomize_robot_color=False):
        initial_qpos = {
        ...
        fetch_env.FetchEnv.__init__(
            ...
            randomize_table_color=randomize_table_color, randomize_floor_color=randomize_floor_color,
            randomize_background_color=randomize_background_color, randomize_robot_color=randomize_robot_color)
